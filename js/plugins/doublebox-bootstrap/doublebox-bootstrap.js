        ...
        box.selectElement = function () {
            if (options.nonSelectedList != null) {
                for (var i in options.nonSelectedList) {
                    if($('.set_'+options.nonSelectedList[i][options.optionValue]).length) continue;
                    if (options.nonSelectedList.hasOwnProperty(i)) {
                        items += "<option class='set_" + options.nonSelectedList[i][options.optionValue] + "' value='" + options.nonSelectedList[i][options.optionValue] + "'>" + options.nonSelectedList[i][options.optionText] + "</option>"
                    }
                }
            }
            if (options.selectedList != null) {
                for (var i in options.selectedList) {
                    if($('.set_'+options.selectedList[i][options.optionValue]).length) continue;
                    if (options.selectedList.hasOwnProperty(i)) {
                        items += "<option class='set_" + options.selectedList[i][options.optionValue] + "' value='" + options.selectedList[i][options.optionValue] + "' selected>" + options.selectedList[i][options.optionText] + "</option>"
                    }
                }
            }
            box.append(items);
