...
*/
(function (d) {
    "function" === typeof define && define.amd ? define(["jquery", "plugins/dataTables/media/js/jquery.dataTables.min"], function (p) {
        return d(p, window, document)
    }) : "object" === typeof exports ? module.exports = function (p, r) {
        p || (p = window);
        if (!r || !r.fn.dataTable) r = require("plugins/dataTables/media/js/jquery.dataTables.min")(p, r).$;
